...
public interface ChallengeMapper {
    ...
    @Mapping(source = "memberChallenge.challenge.startDate", target = "startDate", dateFormat = "yyyyMMdd")
    @Mapping(source = "memberChallenge.challenge.endDate", target = "endDate", dateFormat = "yyyyMMdd")
